  ...
  return (
    <div className="group bg-[#1C1916] rounded-xl sm:rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-black/40 transition-all duration-500 border border-[#C8A66A]/10 flex flex-col h-full">
      ...
      <div className="p-2 sm:p-5 flex flex-col flex-grow justify-between">
        ...
        <div className="mt-2">
          <p className="font-playfair text-sm sm:text-2xl font-semibold text-[#E8E0D8] mb-2 sm:mb-4">₹{price}</p>
          ...
          <div className="flex flex-col gap-1.5 sm:gap-2">
            ...
            {qty === 0 ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-1 sm:gap-2 font-poppins text-[9px] sm:text-[11px] uppercase tracking-wider font-medium py-2 sm:py-3 rounded-md sm:rounded-lg border border-[#C8A66A]/50 text-[#E8E0D8] hover:bg-[#C8A66A] hover:border-[#C8A66A] hover:text-[#141210] transition-all duration-300"
              >
                <ShoppingBag size={12} className="shrink-0" />
                <span>Add</span>
              </button>
            ) : (
              <div className="flex items-center rounded-md sm:rounded-lg overflow-hidden border border-[#C8A66A]/50 bg-[#141210] h-8 sm:h-11">
                {/* Decrease / Remove */}
                <button
                  onClick={handleDecrease}
                  className="flex items-center justify-center w-7 sm:w-11 h-full text-[#C8A66A] hover:bg-[#C8A66A]/10 transition-colors shrink-0"
                ...
                <div className="flex-1 flex items-center justify-center h-full border-x border-[#C8A66A]/20">
                  <span className="font-poppins font-semibold text-xs sm:text-sm text-[#E8E0D8]">{qty}</span>
                </div>
                ...
                <button
                  ...
                  className="flex items-center justify-center w-7 sm:w-11 h-full text-[#C8A66A] hover:bg-[#C8A66A]/10 disabled:opacity-30 disabled:cursor-not-allowed transition-colors shrink-0"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="w-full flex items-center justify-center gap-1 sm:gap-2 font-poppins text-[9px] sm:text-[11px] uppercase tracking-wider font-medium py-2 sm:py-3 rounded-md sm:rounded-lg bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366] hover:text-white border border-[#25D366]/20 transition-all duration-300"
            >
